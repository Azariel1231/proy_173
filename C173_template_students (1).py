...
class parent():
    ...
    def softwareEngineer(it_professional_name):
        ...
        #actualiza el siguiente código al guardarlo dentro de la propiedad 'text' de label_selected_IT
                    = "A "+it_professional_name+" se le asignó "+IT_company_list[random_IT_company]
        
        #define la función chemicalEngineer() y dentro de esta pasa la variable chemical_engineer_name
    def                           :
